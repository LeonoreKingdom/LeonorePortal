...
- Workspace ID: `be763d6f-fd2f-4472-8d82-9093ba09aff7`
- An access token starting with `ngpk_`. Provide it via the `NGODINGPAKEAI_TOKEN`
  ...
  Create one at https://www.ngodingpakeai.com/settings (API keys). Synced content is viewable at https://www.ngodingpakeai.com/workspace/be763d6f-fd2f-4472-8d82-9093ba09aff7.
...
2. `npx ngodingpakeai connect --workspace be763d6f-fd2f-4472-8d82-9093ba09aff7 --token "$NGODINGPAKEAI_TOKEN"` — link this repo to the workspace (first time only).
...
5. Always report the sync summary and https://www.ngodingpakeai.com/workspace/be763d6f-fd2f-4472-8d82-9093ba09aff7. Only pass on links the CLI actually printed — never assemble one from an id yourself.
